...
class InfoGenerator:
    ...
    def generate_email(RANDOM_STRING_LENGTH):
        user = ''.join(random.choices(string.ascii_lowercase, k=RANDOM_STRING_LENGTH))
        anchor = '@'
        domain = ''.join(random.choices(string.ascii_uppercase, k=RANDOM_STRING_LENGTH))
        dot_com = '.com'
    ...
    def generate_node_name(RANDOM_STRING_LENGTH):
        ...
        rand_string = ''.join(random.choices(string.ascii_uppercase + string.digits, k=RANDOM_STRING_LENGTH))
